<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <a href="<?= base_url(); ?>Rt/tambahRt" class="btn btn-primary">Tambah Rt</a>
  </div><!-- End Page Title -->
          ...
          <tbody>
            ...
            <?php foreach ($rt as $row) : ?>
              <tr>
                ...
                <td><?= $row['jumlah_P']; ?></td>
                <td>
                  <a href="<?= base_url(); ?>Rt/editRt/<?= $row['id']; ?>" class="btn btn-warning">Edit</a>
                  <a href="<?= base_url(); ?>Rt/delete/<?= $row['id']; ?>" onclick="return confirm('Yakin Data Ingin Di Hapus');" class="btn btn-danger">Hapus</a>
                </td>
              </tr>
              <?php $no++; ?>
            <?php endforeach; ?>
